...
const TextToSpeech = ({ setDownloadedProjects }) => {
  ...
  const handleSpeak = async () => {
    if (inputText.length === 0 || voices.length > 0) {
      setIsSpeaking(true);
  ...
  const handleDownloadAudio = () => {
    if (audioBlob && projectInfo) {
      ...
      // Add the updated project info to the downloaded projects
      setDownloadedProjects((prevProjects) => [...prevProjects, updatedProjectInfo]);

      
  
      // Show the project form to enter details
      ...
      <Box m="20px">
        ...
        >
          ...
          Convert
            ...
            <Button onClick={() => handleDownloadAudio(projectInfo)}
            sx={{
                backgroundColor: colors.blueAccent[700],
                color: colors.grey[100],
                fontSize: "12px",
